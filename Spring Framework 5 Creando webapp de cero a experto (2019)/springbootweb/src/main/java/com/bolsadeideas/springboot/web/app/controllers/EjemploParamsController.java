...
public class EjemploParamsController {
	...
	/**
	 * Ejemplo de 1 parametro con la anotacion RequestParam
	 * @param texto
	 * @param model
	 * @return
	 */
	...
	/**
	 * Ejemplo de multiples parameteros con la anotacion RequestParam
	 * @param saludo
	 * @param numero
	 * @param model
	 * @return
	...
	/**
	 * Ejemplo de multiples parametros con la clase HttpServlet
	 * @param request
	 * @param model
	 * @return
	 */
