...
public class FERSDbQuery {
	...
	private String insertQuery = "INSERT INTO visitors(id,username,password,firstname,lastname,email,phone_number,address,dni,isadmin) VALUES(?,?,?,?,?,?,?,?,?,?)";
	...
	private String deleteEventSessionSignup = "DELETE FROM events_signup WHERE event_id = ?";
