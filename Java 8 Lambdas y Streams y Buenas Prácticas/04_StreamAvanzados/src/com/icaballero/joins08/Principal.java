package com.icaballero.joins08;
...
public class Principal {
	...
	String nombres = lista.stream().map(Persona::getNombre).collect(Collectors.joining(","));
	String nombres2 = lista.stream().map(Persona::getNombre).collect(Collectors.joining(",","[","]"));	
