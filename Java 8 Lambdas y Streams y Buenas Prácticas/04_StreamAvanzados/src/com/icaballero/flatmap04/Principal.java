package com.icaballero.flatmap04;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		map(d->d.getNombre()).
		//Con esto obligamos a que los deportes sean diferentes
		distinct().
		...
		//Total de horas que juegan a padel
		int total = 
		lista.
		stream().
		flatMap( (p)->p.getDeportes().stream()).
		filter(d->d.getNombre().equals("padel")).
