...
public class Principal5 {
	...
	public static void main(String[] args) {
		...
		List<Persona> nueva = buscarPersonaPorFiltro(FiltroPersona.orMultiple(filtroPedro,filtroJubilado), listaPersona);
	...
	public static List<Persona> buscarPersonaPorFiltro(Predicate<Persona> filtro,List<Persona> lista){
		List<Persona> listFiltro=new ArrayList<Persona>();
