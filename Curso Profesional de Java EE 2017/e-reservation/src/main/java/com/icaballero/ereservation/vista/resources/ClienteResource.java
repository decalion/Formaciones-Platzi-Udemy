 ...
 * 
 */
package com.icaballero.ereservation.vista.resources;
...
import com.icaballero.ereservation.negocio.services.ClienteService;
import com.icaballero.ereservation.vista.resources.vo.ClienteVO;
...
public class ClienteResource {
	...
	public void removedCliente(@PathVariable("identificacion") String identificacion) {
		
		Cliente cliente = this.clienteService.findByIdentificacion(identificacion);
		
		if( cliente!=null) {
			this.clienteService.deleted(cliente);
		}
	}
	...
	@ApiResponses(value = {@ApiResponse(code = 201 , message = "Cliente encontrados"),@ApiResponse(code = 404 , message = "Cliente no encontrado")})
