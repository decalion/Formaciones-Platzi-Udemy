...
public class NoticiasRESTTest {
	...
	public void insertarNoticiaPOST() throws ParseException {
		...
		.post("/noticias")
		.then()
		.statusCode(201); // 201 es igual a que se ha creado un recurso
	...
	public void borrarNoticiaDELETE() {
		...
		.then().statusCode(204); //204 significa que lo ha borrado
