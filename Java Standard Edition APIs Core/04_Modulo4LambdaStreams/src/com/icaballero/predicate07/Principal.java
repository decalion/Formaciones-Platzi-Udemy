...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 *con el metodo and podemos añadir mas filtros
		 *Con el metodo and obligamos a que se cumplan los 2 filtros
		 *con el metodo or tiene que ser un filtro o otro
		 */

		//
		Predicate<Libro> miFiltro = FiltroLibros::cienciaFiccion;
		
		//No sale nada porque se tienen que cumplir los 2 filtros
		Predicate<Libro> nuevoFiltro=miFiltro.and((Libro l) -> l.getCategoria().equals("fantasia"));
		
		
		Predicate<Libro> nuevoFiltroOr=miFiltro.or((Libro l) -> l.getCategoria().equals("fantasia"));
		
		filtro(lista, listaFiltro, nuevoFiltroOr);
